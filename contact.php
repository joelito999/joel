...
if(
	...
	if( empty($_POST['contact-name']) && empty($_POST['contact-phone'])&& empty($_POST['contact-email']) && empty($_POST['contact-subject']) && empty($_POST['contact-message']) ) {
		...
		if( !isset( $_POST['contact-email'] ) || empty( $_POST['contact-phone'] ) ) {
			if( $fields == "" ) {
				$fields .= "Email";
			} else {
				$fields .= ", Email";
		...
		if( !isset( $_POST['contact-phone'] ) || empty( $_POST['contact-email'] ) ) {
			if( $fields == "" ) {
				$fields .= "Phone";
			} else {
				$fields .= ", Phone";
		...
		if( !isset( $_POST['contact-phone'] ) || empty( $_POST['contact-subject'] ) ) {
			if( $fields == "" ) {
				$fields .= "Phone";
			} else {
				$fields .= ", Phone";
